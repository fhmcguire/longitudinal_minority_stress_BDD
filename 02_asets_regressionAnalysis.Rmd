...
# load datasets
imputed_long <- readRDS(file="imputed_long.RDS")
imputed_long_cisgender <- readRDS(file="imputed_long_cisgender.RDS")
imputed_long_transgender <- readRDS(file="imputed_long_transgender.RDS")
...
# Sensitivity 3: Full sample vs. transgender subsample

These models use the same specification as the main model fits. The difference is the sample (3a uses the full sample of participants; 3b uses the transgender subpopulation).
...
# Model 1
future::plan("multisession", workers=5) 
fit_totalEffect_allParticipants <-
  brm_multiple(totalEffectModel, 
               data = imputed_long,
               seed = 828,
               chains = 4,
               ...
               cores = 8,
               control = list(adapt_delta = 0.95),
               file = "fits/sensitivity3_transgender/fit_totalEffect_allParticipants.rds")

# Model 2
future::plan("multisession", workers=5) 
fit_internalizedHomonegativity_allParticipants <-
  brm_multiple(internalizedHomonegativityModel, 
               data = imputed_long,
               seed = 828,
               chains = 4,
               ...
               cores = 8,
               control = list(adapt_delta = 0.95),
               file = "fits/sensitivity3_transgender/fit_internalizedHomonegativity_allParticipants.rds")

# Model 3
future::plan("multisession", workers=5) 
fit_negativeExpectancies_allParticipants <-
  brm_multiple(negativeExpectanciesModel, 
               data = imputed_long,
               seed = 828,
               chains = 4,
               ...
               cores = 8,
               control = list(adapt_delta = 0.95),
               file = "fits/sensitivity3_transgender/fit_negativeExpectancies_allParticipants.rds")

# Model 4
future::plan("multisession", workers=5) 
fit_indirectOverall_allParticipants <-
  brm_multiple(indirectOverallModel, 
               data = imputed_long,
               seed = 828,
               chains = 4,
               ...
               cores = 8,
               control = list(adapt_delta = 0.95),
               file = "fits/sensitivity3_transgender/fit_indirectOverall_allParticipants.rds")
...
# Model 1
future::plan("multisession", workers=5) 
fit_totalEffect_transgender <-
  brm_multiple(totalEffectModel, 
               data = imputed_long_transgender,
               seed = 828,
               chains = 4,
               warmup = 2000,
               iter = 4000,
               ...
               cores = 8,
               control = list(adapt_delta = 0.95),
               file = "fits/sensitivity3_transgender/fit_totalEffect_transgender.rds")

# Model 2
future::plan("multisession", workers=5) 
fit_internalizedHomonegativity_transgender <-
  brm_multiple(internalizedHomonegativityModel, 
               data = imputed_long_transgender,
               seed = 828,
               chains = 4,
               ...
               cores = 8,
               control = list(adapt_delta = 0.95),
               file = "fits/sensitivity3_transgender/fit_internalizedHomonegativity_transgender.rds")

# Model 3
future::plan("multisession", workers=5) 
fit_negativeExpectancies_transgender <-
  brm_multiple(negativeExpectanciesModel, 
               data = imputed_long_transgender,
               seed = 828,
               chains = 4,
               ...
               cores = 8,
               control = list(adapt_delta = 0.95),
               file = "fits/sensitivity3_transgender/fit_negativeExpectancies_transgender.rds")

# Model 4
future::plan("multisession", workers=5) 
fit_indirectOverall_transgender <-
  brm_multiple(indirectOverallModel, 
               data = imputed_long_transgender,
               seed = 828,
               chains = 4,
               ...
               cores = 8,
               control = list(adapt_delta = 0.95),
               file = "fits/sensitivity3_transgender/fit_indirectOverall_transgender.rds")
