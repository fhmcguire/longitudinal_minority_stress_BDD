...
# load model fits for sensitivity 3 (transgender vs. all participants)
# S3a: transgender model fits
fit_totalEffect_transgender <- 
  readRDS(file="fits/sensitivity3_transgender/fit_totalEffect_transgender.rds")
fit_internalizedHomonegativity_transgender <- 
  readRDS(file="fits/sensitivity3_transgender/fit_internalizedHomonegativity_transgender.rds")
fit_negativeExpectancies_transgender <- 
  readRDS(file="fits/sensitivity3_transgender/fit_negativeExpectancies_transgender.rds")
fit_indirectOverall_transgender <- 
  readRDS(file="fits/sensitivity3_transgender/fit_indirectOverall_transgender.rds")


# S3b: all participants model fits
fit_totalEffect_allParticipants <- 
  readRDS(file="fits/sensitivity3_transgender/fit_totalEffect_allParticipants.rds")
fit_internalizedHomonegativity_allParticipants <- 
  readRDS(file="fits/sensitivity3_transgender/fit_internalizedHomonegativity_allParticipants.rds")
fit_negativeExpectancies_allParticipants <- 
  readRDS(file="fits/sensitivity3_transgender/fit_negativeExpectancies_allParticipants.rds")
fit_indirectOverall_allParticipants <- 
  readRDS(file="fits/sensitivity3_transgender/fit_indirectOverall_allParticipants.rds")
...
# Create a matrix called "percent" to hold indirect effect estimates
...
# Create a matrix called "percent" to hold percentage mediated estimates
